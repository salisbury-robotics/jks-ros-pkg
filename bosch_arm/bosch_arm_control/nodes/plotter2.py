...
class DynamicPlot(QwtPlot):
    ...
    def timerEvent(self, e):
        ...
        curve5.setData(time,accX1)
        curve6.setData(time,accY1)
        curve7.setData(time,accZ1)
        curve8.setData(time,accX2)
        curve9.setData(time,accY2)
        curve10.setData(time,accZ2)
...
def js_callback(data):
    ...
    m4values.pop(0)
    #t1.append(data.effort[0]*tf)
    #t1.pop(0)
    #t2.append(data.effort[1]*tf)
    #t2.pop(0)
    #t3.append(data.effort[2]*tf)
    #t3.pop(0)
    #t4.append(data.effort[3]*tf)
    #t4.pop(0)
    lock.release()    
...
if __name__=="__main__":    
    ...
    accX2 = [0 for i in range(length)]
    accY2 = [0 for i in range(length)]
    accZ2 = [0 for i in range(length)]
    
    accX1 = [0 for i in range(length)]
    accY1 = [0 for i in range(length)]
    accZ1 = [0 for i in range(length)]
