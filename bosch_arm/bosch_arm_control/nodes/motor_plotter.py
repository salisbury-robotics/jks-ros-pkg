...
def diag_listener(msg):
    ...
    lock.acquire()
    m1.append(data[0]*m_scale)
    m1.pop(0)
    m2.append(data[1]*m_scale)
    m2.pop(0)
    m3.append(data[2]*m_scale)
    m3.pop(0)
    m4.append(data[3]*m_scale)
    m4.pop(0)
    cm1.append(data[4]*cm_scale)
    cm1.pop(0)
    cm2.append(data[5]*cm_scale)
    cm2.pop(0)
    cm3.append(data[6]*cm_scale)
    cm3.pop(0)
    cm4.append(data[7]*cm_scale)
    cm4.pop(0)
    vm1.append(data[8]*vm_scale)
    vm1.pop(0)
    vm2.append(data[9]*vm_scale)
    vm2.pop(0)
    vm3.append(data[10]*vm_scale)
    vm3.pop(0)
    vm4.append(data[11]*vm_scale)
    vm4.pop(0)
    tm1.append(data[12]*tm_scale)
    tm1.pop(0)
    tm2.append(data[13]*tm_scale)
    tm2.pop(0)
    tm3.append(data[14]*tm_scale)
    tm3.pop(0)
    tm4.append(data[15]*tm_scale)
    tm4.pop(0)
    em1.append(data[16]*em_scale)
    em1.pop(0)
    em2.append(data[17]*em_scale)
    em2.pop(0)
    em3.append(data[18]*em_scale)
    em3.pop(0)
    em4.append(data[19]*em_scale)
    em4.pop(0)

    q1.append(data[20]*q_scale)
    q1.pop(0)
    q2.append(data[21]*q_scale)
    q2.pop(0)
    q3.append(data[22]*q_scale)
    q3.pop(0)
    q4.append(data[23]*q_scale)
    q4.pop(0)
    cq1.append(data[24]*cq_scale)
    cq1.pop(0)
    cq2.append(data[25]*cq_scale)
    cq2.pop(0)
    cq3.append(data[26]*cq_scale)
    cq3.pop(0)
    cq4.append(data[27]*cq_scale)
    cq4.pop(0)
    vq1.append(data[28]*vq_scale)
    vq1.pop(0)
    vq2.append(data[29]*vq_scale)
    vq2.pop(0)
    vq3.append(data[30]*vq_scale)
    vq3.pop(0)
    vq4.append(data[31]*vq_scale)
    vq4.pop(0)
    tq1.append(data[32]*tq_scale)
    tq1.pop(0)
    tq2.append(data[33]*tq_scale)
    tq2.pop(0)
    tq3.append(data[34]*tq_scale)
    tq3.pop(0)
    tq4.append(data[35]*tq_scale)
    tq4.pop(0)
    eq1.append(data[36]*eq_scale)
    eq1.pop(0)
    eq2.append(data[37]*eq_scale)
    eq2.pop(0)
    eq3.append(data[38]*eq_scale)
    eq3.pop(0)
    eq4.append(data[39]*eq_scale)
    eq4.pop(0)
...
def toggle():
    if ui.m1.isChecked():curve_m1.setPen(QPen(Qt.red));plot.replot()
    else: curve_m1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.m2.isChecked():curve_m2.setPen(QPen(Qt.green));plot.replot()
    else: curve_m2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.m3.isChecked():curve_m3.setPen(QPen(Qt.blue));plot.replot()
    else: curve_m3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.m4.isChecked():curve_m4.setPen(QPen(Qt.gray));plot.replot()
    else: curve_m4.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cm1.isChecked():curve_cm1.setPen(QPen(Qt.darkRed));plot.replot()
    else: curve_cm1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cm2.isChecked():curve_cm2.setPen(QPen(Qt.darkGreen));plot.replot()
    else: curve_cm2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cm3.isChecked():curve_cm3.setPen(QPen(Qt.darkBlue));plot.replot()
    else: curve_cm3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cm4.isChecked():curve_cm4.setPen(QPen(Qt.black));plot.replot()
    else: curve_cm4.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vm1.isChecked():curve_vm1.setPen(QPen(Qt.red));plot.replot()
    else: curve_vm1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vm2.isChecked():curve_vm2.setPen(QPen(Qt.green));plot.replot()
    else: curve_vm2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vm3.isChecked():curve_vm3.setPen(QPen(Qt.blue));plot.replot()
    else: curve_vm3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vm4.isChecked():curve_vm4.setPen(QPen(Qt.gray));plot.replot()
    else: curve_vm4.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tm1.isChecked():curve_tm1.setPen(QPen(Qt.yellow));plot.replot()
    else: curve_tm1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tm2.isChecked():curve_tm2.setPen(QPen(Qt.cyan));plot.replot()
    else: curve_tm2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tm3.isChecked():curve_tm3.setPen(QPen(Qt.magenta));plot.replot()
    else: curve_tm3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tm4.isChecked():curve_tm4.setPen(QPen(Qt.gray));plot.replot()
    else: curve_tm4.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.em1.isChecked():curve_em1.setPen(QPen(Qt.darkYellow));plot.replot()
    else: curve_em1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.em2.isChecked():curve_em2.setPen(QPen(Qt.darkCyan));plot.replot()
    else: curve_em2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.em3.isChecked():curve_em3.setPen(QPen(Qt.darkMagenta));plot.replot()
    else: curve_em3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.em4.isChecked():curve_em4.setPen(QPen(Qt.black));plot.replot()
    else: curve_em4.setPen(QPen(Qt.NoPen));plot.replot()
    
    if ui.q1.isChecked():curve_q1.setPen(QPen(Qt.red));plot.replot()
    else: curve_q1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.q2.isChecked():curve_q2.setPen(QPen(Qt.green));plot.replot()
    else: curve_q2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.q3.isChecked():curve_q3.setPen(QPen(Qt.blue));plot.replot()
    else: curve_q3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.q4.isChecked():curve_q4.setPen(QPen(Qt.gray));plot.replot()
    else: curve_q4.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cq1.isChecked():curve_cq1.setPen(QPen(Qt.darkRed));plot.replot()
    else: curve_cq1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cq2.isChecked():curve_cq2.setPen(QPen(Qt.darkGreen));plot.replot()
    else: curve_cq2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cq3.isChecked():curve_cq3.setPen(QPen(Qt.darkBlue));plot.replot()
    else: curve_cq3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cq4.isChecked():curve_cq4.setPen(QPen(Qt.black));plot.replot()
    else: curve_cq4.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vq1.isChecked():curve_vq1.setPen(QPen(Qt.red));plot.replot()
    else: curve_vq1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vq2.isChecked():curve_vq2.setPen(QPen(Qt.green));plot.replot()
    else: curve_vq2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vq3.isChecked():curve_vq3.setPen(QPen(Qt.blue));plot.replot()
    else: curve_vq3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vq4.isChecked():curve_vq4.setPen(QPen(Qt.gray));plot.replot()
    else: curve_vq4.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tq1.isChecked():curve_tq1.setPen(QPen(Qt.yellow));plot.replot()
    else: curve_tq1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tq2.isChecked():curve_tq2.setPen(QPen(Qt.cyan));plot.replot()
    else: curve_tq2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tq3.isChecked():curve_tq3.setPen(QPen(Qt.magenta));plot.replot()
    else: curve_tq3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tq4.isChecked():curve_tq4.setPen(QPen(Qt.gray));plot.replot()
    else: curve_tq4.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.eq1.isChecked():curve_eq1.setPen(QPen(Qt.darkYellow));plot.replot()
    else: curve_eq1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.eq2.isChecked():curve_eq2.setPen(QPen(Qt.darkCyan));plot.replot()
    else: curve_eq2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.eq3.isChecked():curve_eq3.setPen(QPen(Qt.darkMagenta));plot.replot()
    else: curve_eq3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.eq4.isChecked():curve_eq4.setPen(QPen(Qt.black));plot.replot()
    else: curve_eq4.setPen(QPen(Qt.NoPen));plot.replot()
    
    if ui.x1.isChecked():curve_x1.setPen(QPen(Qt.red));plot.replot()
    else: curve_x1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.x2.isChecked():curve_x2.setPen(QPen(Qt.green));plot.replot()
    else: curve_x2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.x3.isChecked():curve_x3.setPen(QPen(Qt.blue));plot.replot()
    else: curve_x3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cx1.isChecked():curve_cx1.setPen(QPen(Qt.darkRed));plot.replot()
    else: curve_cx1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cx2.isChecked():curve_cx2.setPen(QPen(Qt.darkGreen));plot.replot()
    else: curve_cx2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.cx3.isChecked():curve_cx3.setPen(QPen(Qt.darkBlue));plot.replot()
    else: curve_cx3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vx1.isChecked():curve_vx1.setPen(QPen(Qt.red));plot.replot()
    else: curve_vx1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vx2.isChecked():curve_vx2.setPen(QPen(Qt.green));plot.replot()
    else: curve_vx2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.vx3.isChecked():curve_vx3.setPen(QPen(Qt.blue));plot.replot()
    else: curve_vx3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tx1.isChecked():curve_tx1.setPen(QPen(Qt.yellow));plot.replot()
    else: curve_tx1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tx2.isChecked():curve_tx2.setPen(QPen(Qt.cyan));plot.replot()
    else: curve_tx2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.tx3.isChecked():curve_tx3.setPen(QPen(Qt.magenta));plot.replot()
    else: curve_tx3.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.ex1.isChecked():curve_ex1.setPen(QPen(Qt.darkYellow));plot.replot()
    else: curve_ex1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.ex2.isChecked():curve_ex2.setPen(QPen(Qt.darkCyan));plot.replot()
    else: curve_ex2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.ex3.isChecked():curve_ex3.setPen(QPen(Qt.darkMagenta));plot.replot()
    else: curve_ex3.setPen(QPen(Qt.NoPen));plot.replot()

    
    if ui.accX1.isChecked():curve_accX1.setPen(QPen(Qt.red));plot.replot()
    else: curve_accX1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.accY1.isChecked():curve_acc.setPen(QPen(Qt.green));plot.replot()
    else: curve_accY1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.accZ1.isChecked():curve_acc.setPen(QPen(Qt.blue));plot.replot()
    else: curve_accZ1.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.accX2.isChecked():curve_accX2.setPen(QPen(Qt.darkRed));plot.replot()
    else: curve_accX2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.accY2.isChecked():curve_accY2.setPen(QPen(Qt.darkGreen));plot.replot()
    else: curve_accY2.setPen(QPen(Qt.NoPen));plot.replot()
    if ui.accZ2.isChecked():curve_accZ2.setPen(QPen(Qt.darkBlue));plot.replot()
    else: curve_accZ2.setPen(QPen(Qt.NoPen));plot.replot()
