...
:ReleaseBuild
%cmp% /build "Release|x64" "..\..\CHAI3D-VS2008.sln" > output.txt
goto done

:ReleaseForced
%cmp% /rebuild "Release|x64" "..\..\CHAI3D-VS2008.sln"  > output.txt
goto done
...
:DebugBuild
%cmp% /build "Debug|x64" "..\..\CHAI3D-VS2008.sln" > output.txt
goto done

:DebugForced
%cmp% /rebuild "Debug|x64" "..\..\CHAI3D-VS2008.sln" > output.txt
goto done

:clean
%cmp% /clean "Debug|x64"   "..\..\CHAI3D-VS2008.sln" > output.txt
%cmp% /clean "Release|x64" "..\..\CHAI3D-VS2008.sln" > output.txt
goto done
