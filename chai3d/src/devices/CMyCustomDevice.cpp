...
//---------------------------------------------------------------------------
#ifndef _DISABLE_CUSTOM_DEVICE_SUPPORT
//---------------------------------------------------------------------------
...
{
    // the connexion to your device has not yet been established.
    m_systemReady = false;
    ...
    *************************************************************************/
    ...
    /************************************************************************
        ...
        is active or if a USB connexion is available.
...
int cMyCustomDevice::open()
{
    ...
    /************************************************************************
        STEP 3:
        Here you need to implement code which open the connexion to your
        device. This may include opening a connexion to an interface board
        for instance.

        If the connexion fails, simply set the variable 'result' to false.
        If the connexion succeeds, set the variable 'result' to true.
    *************************************************************************/
...
int cMyCustomDevice::close()
{
    ...
    /************************************************************************
        STEP 4:
        Here you need to implement code which closes the connexion to your
        device.

        If the operation fails, simply set the variable 'result' to 0.
        If the connexion succeeds, set the variable 'result' to any
...
unsigned int cMyCustomDevice::getNumDevices()
{
    /************************************************************************
        ...
        In practice you will often have either 0 or 1 device. In wich case
...
//===========================================================================
/*!
    Read the position of your device. Units are in meters.
...
int cMyCustomDevice::getRotation(cMatrix3d& a_rotation)
{
    ...
    /************************************************************************
        ...
        The length of each column vector shuld be of length 1 and vectors need
...
/*!
    ...
    \fn     int cMyCustomDevice::getUserSwitch(int a_switchIndex, int& a_status)
    \param  a_switchIndex  index number of the switch.
    \param  a_status result value from reading the selected input switch.
    \return Return 0 if no error occured.
*/
//===========================================================================
int cMyCustomDevice::getUserSwitch(int a_switchIndex, int& a_status)
{
    int error = 0;
    ...
    /************************************************************************
        ...
        The return value of a switch (a_status) shall be equal to 1 if the button
        is pressed or 0 otherwise.
    *************************************************************************/
...
//---------------------------------------------------------------------------
#endif //_DISABLE_CUSTOM_DEVICE_SUPPORT
//---------------------------------------------------------------------------
