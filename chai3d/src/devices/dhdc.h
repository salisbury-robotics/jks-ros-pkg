 ...
 ****************************************************************************/
  ...
  bool   __API dhdConfigLinearVelocity           (int ms = 20, int mode = DHD_VELOCITY_WINDOWING, char ID = -1);
  int    __API dhdGetLinearVelocity              (double *vx, double *vy, double *vz, char ID = -1);
  int    __API dhdEmulateButton                  (unsigned char val, char ID = -1);
 ...
 ****************************************************************************/
  ...
  int    __API dhdPreset                      (int val[DHD_MAX_ENC], unsigned char mask, char ID = -1);
  int    __API dhdEnableForce                 (unsigned char val, char ID = -1);
 ...
 ****************************************************************************/
  ...
  int    __API dhdSetMot                (short mot[DHD_MAX_ENC], unsigned char mask = 0xff, char ID = -1);
  int    __API dhdGetEnc                (int   enc[DHD_MAX_ENC], unsigned char mask = 0xff, char ID = -1);
  int    __API dhdSetBrk                (unsigned char mask = 0xff, char ID = -1);
