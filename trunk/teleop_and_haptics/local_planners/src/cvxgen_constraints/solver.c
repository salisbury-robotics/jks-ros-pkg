...
double CVX_Constraints::eval_gap(void) {
  int i;
  double gap;
...
void CVX_Constraints::set_defaults(void) {
...
void CVX_Constraints::setup_pointers(void) {
  work.y = work.x + 13;
  work.s = work.x + 19;
  work.z = work.x + 59;
...
void CVX_Constraints::setup_indexed_params(void) {
  ...
  params.J_c[16] = params.J_c_16;
  params.normal[17] = params.normal_17;
  params.J_c[17] = params.J_c_17;
  params.normal[18] = params.normal_18;
  params.J_c[18] = params.J_c_18;
  params.normal[19] = params.normal_19;
  params.J_c[19] = params.J_c_19;
  params.normal[20] = params.normal_20;
  params.J_c[20] = params.J_c_20;
  params.normal[21] = params.normal_21;
  params.J_c[21] = params.J_c_21;
  params.normal[22] = params.normal_22;
  params.J_c[22] = params.J_c_22;
  params.normal[23] = params.normal_23;
  params.J_c[23] = params.J_c_23;
  params.normal[24] = params.normal_24;
  params.J_c[24] = params.J_c_24;
  params.normal[25] = params.normal_25;
  params.J_c[25] = params.J_c_25;
}

void CVX_Constraints::setup_indexing(void) {
  setup_pointers();
  setup_indexed_params();
}

void CVX_Constraints::set_start(void) {
  int i;
...
double CVX_Constraints::eval_objv(void) {
  int i;
  double objv;
...
void CVX_Constraints::fillrhs_aff(void) {
  int i;
  double *r1, *r2, *r3, *r4;
...
void CVX_Constraints::fillrhs_cc(void) {
  int i;
...
void CVX_Constraints::refine(double *target, double *var) {
  int i, j;
...
double CVX_Constraints::calc_ineq_resid_squared(void) {
...
double CVX_Constraints::calc_eq_resid_squared(void) {
...
void CVX_Constraints::better_start(void) {
...
void CVX_Constraints::fillrhs_start(void) {
...
long CVX_Constraints::solve(void) {
  int i;
  int iter;
