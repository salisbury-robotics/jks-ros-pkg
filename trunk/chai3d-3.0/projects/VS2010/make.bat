...
REM  
REM  \author    <http://www...\..\CHAI3D-VS2010.org>
...
:ReleaseBuild
%cmp% /build "Release|Win32" "..\..\CHAI3D-VS2010.sln" > output.txt
goto done

:ReleaseForced
%cmp% /rebuild "Release|Win32" "..\..\CHAI3D-VS2010.sln"  > output.txt
goto done
...
:DebugBuild
%cmp% /build "Debug|Win32" "..\..\CHAI3D-VS2010.sln" > output.txt
goto done

:DebugForced
%cmp% /rebuild "Debug|Win32" "..\..\CHAI3D-VS2010.sln" > output.txt
goto done

:clean
%cmp% /clean "Debug|Win32"   "..\..\CHAI3D-VS2010.sln" > output.txt
%cmp% /clean "Release|Win32" "..\..\CHAI3D-VS2010.sln" > output.txt
goto done
