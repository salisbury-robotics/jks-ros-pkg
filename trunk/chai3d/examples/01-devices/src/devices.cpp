...
int main(int argc, char* argv[])
{
    ...
    while (i < numHapticDevices)
    {
        ...
        if (info.m_sensedRotation == true)
        {
            ...
            newCursor->setFrameSize(0.05, 0.02);
        }
    ...
    // a light blue material color
    matCursorButtonON.m_ambient.set(0.2, 0.4, 0.5);
    matCursorButtonON.m_diffuse.set(0.5, 0.8, 1.0);
...
void updateHaptics(void)
{
    ...
    while(simulationRunning)
    {
        ...
        while (i < numHapticDevices)
        {
            ...
            // send a force to the haptic device to bring the
            // end-effector towards the device origin (0,0,0)
            double springK = 20.0; // [N/m]
            cVector3d newForce = cMul(-springK, newPosition);
