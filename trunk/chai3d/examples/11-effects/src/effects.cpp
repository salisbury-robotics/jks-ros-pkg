...
int main(int argc, char* argv[])
{
	...
	fileload = object0->m_texture->loadFromFile("./resources/images/chrome.bmp");
	if (!fileload)
	{
		#if defined(_WIN32)
    ...
    object0->useTexture(true);

    // set haptic properties
    object0->m_material.setStiffness(0.8 * stiffnessMax);
    object0->m_material.setMagnetMaxForce(0.2 * forceMax);
    object0->m_material.setMagnetMaxDistance(0.1);
	...
	fileload = object1->m_texture->loadFromFile("./resources/images/water.bmp");
	if (!fileload)
	{
		#if defined(_WIN32)
    ...
    object1->useTexture(true);

    // set haptic properties
    object1->m_material.setViscosity(2.0);
	...
	fileload = object2->m_texture->loadFromFile("./resources/images/stone.bmp");
	if (!fileload)
	{
		#if defined(_WIN32)
    ...
    object2->useTexture(true);

    // set haptic properties
    object2->m_material.setStickSlipForceMax(0.2 * forceMax);
    object2->m_material.setStickSlipStiffness(0.4 * stiffnessMax);
	...
	fileload = object3->m_texture->loadFromFile("./resources/images/plastic.bmp");
	if (!fileload)
	{
		#if defined(_WIN32)
