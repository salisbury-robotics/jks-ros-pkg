...
int main(int argc, char* argv[])
{
    ...
    // load an object file
	fileload = turntable->loadFromFile("./resources/models/turntable/turntable.obj");
	if (!fileload)
	{
		#if defined(_WIN32)
    ...
    file_stream = BASS_StreamCreateFile(FALSE,"./resources/sounds/classic.mp3",0,0,BASS_STREAM_DECODE);
	if (file_stream == 0)
	{
		#if defined(_WIN32)
	...
	fileload = recordImage->loadFromFile("./resources/images/record.bmp");
	if (!fileload)
	{
		#if defined(_WIN32)
