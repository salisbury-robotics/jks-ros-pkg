...
:ReleaseBuild
%cmp% /build "Release|Win32" "ODE-VS2008.sln" > output.txt
goto done

:ReleaseForced
%cmp% /rebuild "Release|Win32" "ODE-VS2008.sln"  > output.txt
goto done
...
:DebugBuild
%cmp% /build "Debug|Win32" "ODE-VS2008.sln" > output.txt
goto done

:DebugForced
%cmp% /rebuild "Debug|Win32" "ODE-VS2008.sln" > output.txt
goto done

:clean
%cmp% /clean "Debug|Win32"   "ODE-VS2008.sln" > output.txt
%cmp% /clean "Release|Win32" "ODE-VS2008.sln" > output.txt
goto done
