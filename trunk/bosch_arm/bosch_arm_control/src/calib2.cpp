/** Calibration for friction/gravity compensation.
  *
**/
#include "ros/ros.h"
#include "cc2.h"
...
//initialized joint state and cmd.
void initialize()
{
...
void move_joints_relative(const double * rel,double t, double *torque)
{
  ...
  for (int i=0;i<4;i++)
  {
    init_cmd_pos[i]=cmd.coordinates[i];
  }
...
int main(int argc, char **argv)
{
  ...
  //rotate joint 4 by -2.3
  
  //rotate joint 3 by -pi/2  
  //rotate joint 1 by -pi/2  
  //rotate joint 4 by 5, record friction profile  
  //rotate joint 4 by -5, record friction profile  
  //rotate joint 1 by pi/2  
  //rotate joint 3 by pi/2
  ...
  //rotate joint 4 by 2.3, set compensation profile
