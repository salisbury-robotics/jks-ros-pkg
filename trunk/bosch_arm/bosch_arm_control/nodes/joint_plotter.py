...
def diag_listener(msg):
    ...
    lock.acquire()
    m1.append(data[20]*m_scale)
    m1.pop(0)
    m2.append(data[21]*m_scale)
    m2.pop(0)
    m3.append(data[22]*m_scale)
    m3.pop(0)
    m4.append(data[23]*m_scale)
    m4.pop(0)
    ...
    #cm4.pop(0)
    vm1.append(data[24]*vm_scale)
    vm1.pop(0)
    vm2.append(data[25]*vm_scale)
    vm2.pop(0)
    vm3.append(data[26]*vm_scale)
    vm3.pop(0)
    vm4.append(data[27]*vm_scale)
    vm4.pop(0)
    tm1.append(data[28]*tm_scale)
    tm1.pop(0)
    tm2.append(data[29]*tm_scale)
    tm2.pop(0)
    tm3.append(data[30]*tm_scale)
    tm3.pop(0)
    tm4.append(data[31]*tm_scale)
    tm4.pop(0)
    ...
    q1.append(data[0]*q_scale)
    q1.pop(0)
    q2.append(data[1]*q_scale)
    q2.pop(0)
    q3.append(data[2]*q_scale)
    q3.pop(0)
    q4.append(data[3]*q_scale)
    q4.pop(0)
    cq1.append(data[4]*cq_scale)
    cq1.pop(0)
    cq2.append(data[5]*cq_scale)
    cq2.pop(0)
    cq3.append(data[6]*cq_scale)
    cq3.pop(0)
    cq4.append(data[7]*cq_scale)
    cq4.pop(0)
    vq1.append(data[8]*vq_scale)
    vq1.pop(0)
    vq2.append(data[9]*vq_scale)
    vq2.pop(0)
    vq3.append(data[10]*vq_scale)
    vq3.pop(0)
    vq4.append(data[11]*vq_scale)
    vq4.pop(0)
    tq1.append(data[12]*tq_scale)
    tq1.pop(0)
    tq2.append(data[13]*tq_scale)
    tq2.pop(0)
    tq3.append(data[14]*tq_scale)
    tq3.pop(0)
    tq4.append(data[15]*tq_scale)
    tq4.pop(0)
    eq1.append(data[16]*eq_scale)
    eq1.pop(0)
    eq2.append(data[17]*eq_scale)
    eq2.pop(0)
    eq3.append(data[18]*eq_scale)
    eq3.pop(0)
    eq4.append(data[19]*eq_scale)
    eq4.pop(0)
